                    ...
                    <form class="auth-form" id="signupForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-select-container">
                                <div class="custom-select" onclick="toggleCitySelect('signup')">
                                    <div class="select-selected" id="signupCitySelected">Select your city</div>
                                    <div class="select-arrow">▼</div>
                                </div>
                                <div class="select-items" id="signupCityDropdown">
                                    <div class="search-container">
                                        <input type="text" class="search-input" placeholder="Search cities..." id="signupCitySearch" oninput="filterCities('signup')">
                                    </div>
                                    <div class="options-container" id="signupCityOptions">
                                        ${indianCities.map(city => `
                                            <div class="select-option" onclick="selectCity('${city}', 'signup')">${city}</div>
                                        `).join('')}
                                    </div>
                                </div>
                                <input type="hidden" id="signupCity" required>
                            </div>
                        </div>
...
async function handleSignup(e) {
    ...
    if (!indianCities.includes(city)) {
        alert('Please select a valid Indian city from the dropdown');
        return;
    }
...
async function loadHomePage() {
    ...
    try {
        ...
        const topTrendingItems = trendingItems.slice(0, 10);
        console.log('Trending items:', topTrendingItems.length);
        ...
        renderTrendingItems(topTrendingItems, 'trendingSection');
...
async function getTrendingItems() {
    try {
        ...
        return allItems.sort((a, b) => b.likes - a.likes);
...
function getTopCreators() {
    try {
        ...
        users.forEach(user => {
            ...
            // Calculate score (weighted: shops * 10 + upvotes * 2 + item likes)
            const score = (userShops.length * 10) + (totalUpvotes * 2) + totalItemLikes;
        ...
        return Object.values(creatorScores)
        ...
        return `
            <div class="trending-item-card" onclick="viewShopDetail('${item.shopId}', ${item.itemIndex})">
                ...
                <div class="trending-item-content">
                    ...
                    <div class="trending-item-shop">${item.shopName}</div>
        ...
        return `
            <div class="shop-card-horizontal" onclick="viewShopDetail('${shop.id}')">
                ...
                <div class="shop-content-horizontal">
                    ...
                    <div class="vote-container" style="position: relative; margin-top: 10px;">
                        <button class="vote-btn upvote-btn" onclick="event.stopPropagation(); vote('${shop.id}', 'up', event)">
                        ...
                        <button class="vote-btn downvote-btn" onclick="event.stopPropagation(); vote('${shop.id}', 'down', event)">
